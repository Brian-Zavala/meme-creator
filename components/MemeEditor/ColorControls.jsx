        ...
        <div className="relative flex items-center justify-center w-auto shrink-0" title="Text Color">
          {(meme.textColor.substring(0, 7) !== '#ffffff' || getOpacity(meme.textColor) < 100) && (
            <button
              ...
              className="absolute -top-6 -left-2 sm:-left-3 text-[9px] uppercase font-bold text-slate-500 hover:text-white transition-colors bg-slate-800/80 px-1.5 py-0.5 rounded whitespace-nowrap backdrop-blur-sm border border-slate-700/50 z-10"
            >
              Reset
            </button>
          )}
