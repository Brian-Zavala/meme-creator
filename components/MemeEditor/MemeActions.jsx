import { ImagePlus, Eraser, Download, Share2 } from "lucide-react";

export function MemeActions({ onFileUpload, onReset, onDownload, onShare }) {
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      <button
        onClick={onReset}
        className="bg-red-900/20 hover:bg-red-900/40 text-red-400 font-semibold py-3 px-4 rounded-xl transition-all active:scale-95 flex items-center justify-center gap-2 border border-red-900/50 col-span-2"
      >
