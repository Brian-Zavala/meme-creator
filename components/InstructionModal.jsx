...
export function InstructionModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed pb-16 inset-0 z-[200] flex items-center justify-center p-4 pt-36 sm:pt-4 backdrop-blur-xl bg-black/40 animate-in fade-in duration-500">
