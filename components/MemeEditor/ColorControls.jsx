...
export default function ColorControls({ meme, handleStyleChange, handleStyleCommit }) {
  ...
  return (
    <div className="w-full md:w-auto flex flex-row flex-wrap items-start justify-center md:justify-end gap-6 animate-in slide-in-from-right duration-500">
      
      {/* Text Color + Opacity */}
      <div className="flex flex-col items-center gap-3 w-20">
        <div className="relative flex items-center justify-center w-full" title="Text Color">
            ...
            <Palette className="absolute left-0 -ml-1 w-4 h-4 text-slate-400 pointer-events-none" aria-hidden="true" />
            <div className="relative overflow-hidden w-10 h-10 rounded-full ring-2 ring-slate-700 hover:ring-slate-500 transition-all cursor-pointer focus-within:ring-yellow-500 shadow-sm ml-auto">
            <input
        ...
        <input
            ...
            className="w-full accent-[oklch(53%_0.187_39)] cursor-pointer h-1.5 rounded-full opacity-70 hover:opacity-100 transition-opacity animate-in fade-in duration-300"
            title="Text Opacity"
        />
      </div>

      {/* Outline Color + Opacity */}
      <div className="flex flex-col items-center gap-3 w-20 animate-in fade-in zoom-in duration-300">
        <div className="relative flex items-center justify-center w-full" title="Outline Color">
            ...
            <div className="absolute left-0 -ml-1 w-4 h-4 text-slate-400 shrink-0 flex items-center justify-center font-black text-[10px] border border-slate-400 rounded-sm pointer-events-none">T</div>
            <div className="relative overflow-hidden w-10 h-10 rounded-full ring-2 ring-slate-700 hover:ring-slate-500 transition-all cursor-pointer focus-within:ring-yellow-500 shadow-sm ml-auto">
            <input
      ...
      <div className="flex flex-col items-center gap-3 w-20 animate-in fade-in zoom-in duration-300">
        <div className="relative flex items-center justify-center w-full" title="Background Color">
        ...
        <Brush className="absolute left-0 -ml-1 w-4 h-4 text-slate-400 pointer-events-none" aria-hidden="true" />
        <div className="relative overflow-hidden w-10 h-10 rounded-full ring-2 ring-slate-700 hover:ring-slate-500 transition-all cursor-pointer focus-within:ring-yellow-500 shadow-sm ml-auto">
            <input
        ...
        <input
            ...
            className="w-full accent-[oklch(53%_0.187_39)] cursor-pointer h-1.5 rounded-full opacity-70 hover:opacity-100 transition-opacity"
