...
function renderLayer2(activeTab, activeTool, meme, handlers) {
  const { handleStyleChange, handleFilterChange, handleStyleCommit, onAnimationChange, onAddSticker, handleToolTap } = handlers;
...
export default function MobileBottomBar({
  ...
  const handlers = { handleStyleChange, handleFilterChange, handleStyleCommit, onAnimationChange, onAddSticker, handleToolTap };
