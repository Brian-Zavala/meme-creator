// components/MemeEditor/ImageSourceTabs.jsx
import React from 'react';

const SOURCES = [
  { id: "imgflip", label: "Meme" },
  { id: "unsplash", label: "Unsplash" },
  { id: "pexels", label: "Pexel" },
];
      ...
      {SOURCES.map(({ id, label }) => {
        ...
        return (
          <button
            ...
            className={`
              relative flex-1 flex items-center justify-center gap-2 py-2 px-1 rounded-lg text-xs font-bold transition-all duration-200
              ${isActive
